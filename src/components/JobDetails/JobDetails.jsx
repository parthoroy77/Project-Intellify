    ...
    return (
        <div className='flex w-full px-12 md:px-28 my-16'>
            <div className='w-3/5 left-side p-4'>
                <p className=' text-xl mb-7'><span className='font-bold text-2xl'>Job Description:</span> <span className='small-texts'>{job_description}</span></p>
                <p className=' text-xl mb-7'><span className='font-bold text-2xl'>Job Responsibility:</span> <span className='small-texts'>{job_responsibility}</span></p>
            ...
            <div className='w-2/5 right-side px-10 py-6 '>
